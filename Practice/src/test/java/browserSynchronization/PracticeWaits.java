...
public class PracticeWaits {
    ...
    public void testEtsy(){
        driver.get("https://www.etsy.com/"); // the only case when we don't need to
    ...
    @Test
    public void visibleAfterFiveSeconds(){
        //using explicit wait wait for the button to be visible on the page
        //verify the button is displayed
        driver.get("https://demoqa.com/dynamic-properties");
        WebDriverWait wait = new WebDriverWait(driver,5);
        WebElement visibleButton = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@id='visibleAfter']")));
        Assert.assertTrue("Visible After 5 seconds is not visible", visibleButton.isDisplayed());
    }
    ...
    public void testFileUpload() throws InterruptedException{
        ...
        //then I need to sendKeys() with path to my file to the input field
        WebElement chooseFileInput =  driver.findElement(By.xpath("//input[@id='uploadFile']"));
        chooseFileInput.sendKeys("/Users/admin/Desktop/devxLogo.png");
    ...
    @Test
    public void testUploadImageToGoogle() {
        ...
        driver.findElement(By.xpath("//input[@id='awyMjb']")).sendKeys("/Users/admin/Desktop/disney.jpeg");
    }
}
